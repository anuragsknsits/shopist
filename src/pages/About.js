  ...
  return (
    <Accordion defaultActiveKey={['0']} alwaysOpen>
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          An esteemed Chartered Accountant firm in Patna with a growing team of professionals.
          Established to create a benchmark in value-added and quality professional services in Direct and Indirect Taxation in India.
        </Accordion.Body>
      </Accordion.Item>
